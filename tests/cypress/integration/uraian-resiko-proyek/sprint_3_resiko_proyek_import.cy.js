...
const fileName = "Uraian Resiko Proyek.xlsx";
...
describe("case positive", function () {
    ...
    it("import data uraian resiko proyek", function () {
...
describe("case negative", function () {
    ...
    it("import data uraian resiko proyek mengunakan file salah", function () {
        cy.intercept({ method: "POST" });
        cy.intercept({
            method: "POST",
            url: "profile.pengusaha.import",
    ...
    it("import data uraian resiko proyek tidak masukan input", function () {
        cy.visit("/");
        cy.get('[data-id="inputEmail"]').type(this.data.email);
        cy.get('[data-id="inputPassword"]').type(this.data.password);
        cy.get('[data-id="buttonLogin"]').click();
