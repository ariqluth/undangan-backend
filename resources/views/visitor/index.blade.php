...
@section('contentvisitor')
    <section class="section">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col" style="display: none">
                            ...
                            <select id="kecamatan-filter" class="form-control select2">
                                @foreach ($kecamatans as $kecamatan)
                                    <option value="{{ $kecamatan->nama_kecamatan }}">{{ $kecamatan->nama_kecamatan }}
                                    </option>
                                @endforeach
                            </select>
                            <label for="kelurahan-filter">Kelurahan:</label>
                            <select id="kelurahan-filter" class="form-control select2">
                                @foreach ($kelurahans as $kelurahan)
                                    <option value="{{ $kelurahan->nama_kelurahan }}">{{ $kelurahan->nama_kelurahan }}
                                    </option>
                                @endforeach
                            </select>
                            <label for="chart-type">Chart Type:</label>
                            <select id="chart-type" class="form-control select2">
        ...
        <div class="row">
                        ...
                        <div class="card-body" id="cardP">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan"
                                    placeholder="Nama Perusahaan" data-id="search-perusahaan"
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <select class="form-control select2" name="kbli[]" multiple data-id="select-kbli"
                                        id="kbli"
                                        style="display: flex;
                                    flex-wrap: wrap;
                                    align-items: center;">
            ...
            <div class="col-5  col-lg-7" height="200px">
                <div class="card card-primary">
                    <div class="card">
                        <div class="card-body" id="render-map" style="height: 655px;width: 100%; z-index: 1;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        <strong>Kbli:</strong> ${kbli || 'N/A'}-${judulkbli || 'N/A'}-${sektor || 'N/A'}<br>`;
            ...
            const marker = L.marker([latitude || 0, longitude || 0],
                markerOptions); // Set default values (0) for latitude and longitude if they are nullable
            marker.addTo(map);
            marker.bindPopup(popupContent);
            marker.openPopup();
        }
