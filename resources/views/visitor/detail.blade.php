...
@section('contentvisitor')
    <section class="section">
        <div class="section-header">
            <h1>Tampilan Profil Komoditas</h1>
        ...
        <div class="section-body">
            ...
            <div class="row">
                            ...
                            <div class="row-borderlis">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <p id="preview-user">{{ $artikel->name }}</p>
                                    </div>
                                    <div class="col">
                ...
                <div class="col col-lg-9" id="random-artikel" style="margin-top:-20px">
                    <div class="card">
                        <div class="card-header">
                                    ...
                                    @foreach ($artikels as $key => $arts)
                                        <div class="show-random-artikel-luar">
                                            <ul>
                                                ...
                                                <a href="{{ route('visitor.detail', $arts->slug) }}">
