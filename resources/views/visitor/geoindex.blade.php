    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-12  col-lg-5">
                    <div class="card-body" id="render-map" style="height: 790px;width: 800px; z-index: 1;">
                    </div>
                </div>
        ...
        // fetch('{{ url('/api/visitormap') }}')
            ...
            .then(responseData => {
                if (Array.isArray(responseData.data)) {
                    ...
                    addGeoJsonLayer('{{ asset('assets/js/pacitanJson.json') }}', pacitanLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/pringkukuJson.json') }}', pringkukuLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/nawanganJson.json') }}', nawanganLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/donorojoJson.json') }}', donorojoLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/keboagungJson.json') }}', keboagungLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/punungJson.json') }}', punungLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/arjosariJson.json') }}', arjosariLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/sudimoroJson.json') }}', sudimoroLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/tulakanJson.json') }}', tulakanLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/tegalomboJson.json') }}', tegalomboLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/bandarJson.json') }}', bandarLayer, markersData);
                    addGeoJsonLayer('{{ asset('assets/js/ngadirejoJson.json') }}', ngadirejoLayer, markersData);
                } else {
