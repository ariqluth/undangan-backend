...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Tambah Uraian Resiko Proyek</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('uraian-resiko-proyek.store') }}" method="post">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_uraian_resiko_proyek') is-invalid @enderror"
                                ...
                                value="{{ old('nama_uraian_resiko_proyek') }}" data-id="resiko-proyek">
                ...
                <div class="card-footer text-right">
                    ...
                    <a class="btn btn-secondary" href="{{ route('uraian-resiko-proyek.index') }}">Cancel</a>
                </div>
                </form>
            </div>
        </div>
