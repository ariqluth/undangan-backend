...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit Uraian Jenis Perusahaan</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('uraian-jenis-perusahaan.update', $uraian_jenis_perusahaan) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_uraian_jenis_perusahaan') is-invalid @enderror"
                                ...
                                value="{{ old('nama_uraian_jenis_perusahaan', $uraian_jenis_perusahaan->nama_uraian_jenis_perusahaan) }}" data-id="jenis-perusahaan">
                ...
                <div class="card-footer text-right">
                    ...
                    <a class="btn btn-secondary" href="{{ route('uraian-jenis-perusahaan.index') }}" data-id="cancel">Cancel</a>
                </div>
                </form>
            </div>
        </div>
