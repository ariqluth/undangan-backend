...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body">
                <form method="post" enctype="multipart/form-data" action="{{ route('kategori-artikel.update',$kategoriArtikel) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nama_kategori">Nama Kategori</label>
                        <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror" id="nama_kategori"
                            name="nama_kategori" placeholder="nama_kategori" value="{{ old('nama_kategori', $kategoriArtikel->nama_kategori) }}" data-id="nama_kategori" autocomplete="off">
                        @error('nama_kategori')
