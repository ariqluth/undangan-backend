...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Tambah Uraian Skala Usaha</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('uraian-skala-usaha.store') }}" method="post">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_uraian_skala_usaha') is-invalid @enderror"
                                ...
                                value="{{ old('nama_uraian_skala_usaha') }}" data-id="skala-usaha">
                ...
                <div class="card-footer text-right">
                    ...
                    <a class="btn btn-secondary" href="{{ route('uraian-skala-usaha.index') }}">Cancel</a>
                </div>
                </form>
            </div>
        </div>
