    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kbli-perusahaan.update', $kbli_perusahaan) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        {{-- batas --}}
                        <div id="page-1" class="displapage hilang">
                            ...
                            <div class="form-group npwp-form-group">
                                <label>NPWP</label>
                                <input type="text" class="form-control @error('kode_proyek') is-invalid @enderror"
                                    id="npwp" name="npwp" placeholder="Pilih NPWP"
                        ...
                        <div id="page-3" class="displapage">
                            ...
                            <div class="form-group gambar-form-group">
                                <label>Gambar </label>
                                <input type="file" class="form-control-file @error('gambar') is-invalid @enderror" id="gambar" name="gambar" data-id="gambar"  onchange="return validasiEkstensi()">
                                @error('gambar')
