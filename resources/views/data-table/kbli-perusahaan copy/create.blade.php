                        ...
                        <div id="page-3" class="displapage">
                            ...
                            <div class="form-group gambar-form-group">
                                ...
                                <input type="file" class="form-control-file @error('gambar') is-invalid @enderror"
                                    id="gambar" name="gambar" data-id="gambar" accept="image/*"
...
@push('customScript')
    ...
    <script>
        ...
        if ('{{ session()->has('selected_kbli_id') }}') {
            // Ambil nilai session selected_kbli_id
            var selected_kbli_id = '{{ session('selected_kbli_id') }}';

            // Set selected value pada dropdown kbli_id
            $("#kbli_id").val(selected_kbli_id).trigger("change");
        }

        // Fungsi untuk menghapus session selected_kbli_id
        ...
        // Tangani perubahan pada dropdown kbli_id
        $('#kbli_id').on('change', function() {
            // Simpan nilai dropdown kbli_id ke dalam session
        ...
        // Clear session selected_kbli_id ketika user meninggalkan halaman
        $(window).on('beforeunload', function() {
            clearSelectedKbliId();
        });

        // Clear session selected_kbli_id ketika user mengklik tombol "Tambah Data Perusahaan"
