                                                ...
                                                <td colspan="10">
                                                    ...
                                                    <table class="table table-bordered table-md">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('assets/img/' . $kbliperusahaan->gambar) }}" alt="{{ $kbliperusahaan->nama_perusahaan }}" width="100"></td>
                                                        </tr>
                                                    </table>
                                                    <br />
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kecamatan').change(function() {
                var kecamatanIds = $(this).val(); // get an array of selected kecamatan IDs
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        kecamatan_id: kecamatanIds, // pass an array of kecamatan IDs
                        _token: "{{ csrf_token() }}"
                    },
